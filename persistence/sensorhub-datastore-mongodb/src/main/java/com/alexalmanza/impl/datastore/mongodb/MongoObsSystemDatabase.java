...
import org.sensorhub.impl.datastore.h2.MongoObsSystemDatabaseConfig;
 ...
 * @date Sep 23, 2019
 */
public class MongoObsSystemDatabase extends AbstractModule<MongoObsSystemDatabaseConfig> implements IObsSystemDatabase, IProcedureDatabase, IObsSystemDatabaseModule<MongoObsSystemDatabaseConfig>
{
    ...
    MongoSystemStoreImpl systemStore;
    MongoDeploymentStoreImpl deploymentStore;
    MongoObsStoreImpl obsStore;
    MongoFoiStoreImpl foiStore;
    MongoCommandStoreImpl cmdStore;
    MongoProcedureStoreImpl procedureStore;
    MongoPropertyStoreImpl propertyStore;
    ...
    protected void beforeInit() throws SensorHubException
    {
        ...
        // TODO: Check connection opts
        Asserts.checkNotNull(config.uri);
    }
    ...
    protected void doStart() throws SensorHubException
    {
        try
        {
            ...
            // TODO: Register codecs for OSH data model
            CodecRegistry myRegistry = CodecRegistries.fromProviders(
