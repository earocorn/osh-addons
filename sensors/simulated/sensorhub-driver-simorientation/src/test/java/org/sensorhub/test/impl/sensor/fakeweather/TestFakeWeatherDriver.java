...
import com.botts.impl.sensor.simorientation.SimOrientationConfig;
import com.botts.impl.sensor.simorientation.SimOrientationSensor;
...
{
    SimOrientationSensor driver;
    SimOrientationConfig config;
    ...
    {
        config = new SimOrientationConfig();
        config.id = UUID.randomUUID().toString();
        
        driver = new SimOrientationSensor();
        driver.init(config);
    }
