...
public class ModuleApiSecurity extends ModuleSecurity implements RestApiSecurity
{
    ...
    public ModuleApiSecurity(ModuleApiService service, boolean enable)
    {
        ...
        ModulePermissions wildcardPerm = rootPerm.cloneAsTemplatePermission("Registration API Services");
