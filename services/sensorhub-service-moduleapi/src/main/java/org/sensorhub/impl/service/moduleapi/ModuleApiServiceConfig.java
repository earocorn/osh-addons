...
/**
 * <p>
 * Configuration class for the Module API service module
 * </p>
 *
 * @author Alex Almanza
 * @since Oct 20, 2024
 */
public class ModuleApiServiceConfig extends OGCServiceConfig
{
    ...
    public ModuleApiServiceConfig()
    {
        this.moduleClass = ModuleApiService.class.getCanonicalName();
        this.endPoint = "/moduleapi";
    }
}
