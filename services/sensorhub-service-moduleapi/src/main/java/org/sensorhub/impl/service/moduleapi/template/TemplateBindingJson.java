...
public class TemplateBindingJson extends ResourceBindingJson<String, ModuleConfig> {

    protected TemplateBindingJson(RequestContext ctx, IdEncoders idEncoders, boolean forReading) throws IOException {
