...
public class ProtobufParserDescriptor extends JarModuleProvider implements IModuleProvider
{
    @Override
    public String getModuleName()
    {
        return "Protobuf Data Parser";
    }
    ...
    {
        return "Parses data formatted in protobuf ";
    }
    ...
    public Class<? extends ModuleConfigBase> getModuleConfigClass() {
        return ProtobufDataParserConfig.class;
    }
}
